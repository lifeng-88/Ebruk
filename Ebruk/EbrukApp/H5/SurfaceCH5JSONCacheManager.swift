//
//  SurfaceCH5JSONCacheManager.swift
//  App
//
...
final class SurfaceCH5JSONCacheManager {
    static let shared = SurfaceCH5JSONCacheManager()
    ...
    private init() {
        ...
        directory = caches.appendingPathComponent("SurfaceCH5JSONCache", isDirectory: true)

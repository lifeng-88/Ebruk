//
//  SurfaceCH5MediaCacheSchemeHandler.swift
//  App
//
...
final class SurfaceCH5MediaCacheSchemeHandler: NSObject, WKURLSchemeHandler {
    ...
    private func serve(_ urlSchemeTask: WKURLSchemeTask, taskID: ObjectIdentifier) {
        ...
        guard let requestURL = urlSchemeTask.request.url,
              ...
              let fileURL = SurfaceCH5MediaCacheManager.shared.cachedURL(for: remoteURLString, mediaType: mediaType),

//
//  SurfaceCH5MediaCacheManager.swift
//  App
//
...
final class SurfaceCH5MediaCacheManager {
    static let shared = SurfaceCH5MediaCacheManager()
    ...
    private init() {
        ...
        videoDirectory = caches.appendingPathComponent("SurfaceCH5VideoCache", isDirectory: true)
        imageDirectory = caches.appendingPathComponent("SurfaceCH5ImageCache", isDirectory: true)
    ...
    func displayURL(for remoteURLString: String, mediaType: String? = nil) -> URL? {
        ...
        components.scheme = SurfaceCH5MediaCacheSchemeHandler.scheme

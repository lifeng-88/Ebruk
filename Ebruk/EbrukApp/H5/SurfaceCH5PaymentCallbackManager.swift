//
//  SurfaceCH5PaymentCallbackManager.swift
//  App
//
...
extension Notification.Name {
    static let surfaceCH5PaymentCallbackReceived = Notification.Name("surfaceCH5PaymentCallbackReceived")
}

final class SurfaceCH5PaymentCallbackManager {
    static let shared = SurfaceCH5PaymentCallbackManager()

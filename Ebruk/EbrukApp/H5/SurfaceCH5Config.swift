...
enum SurfaceCH5Config {
    private(set) static var pageChannel: String?

    static let appDisplayName = Bundle.main.object(forInfoDictionaryKey: "CFBundleDisplayName") as? String ?? "Ebruk"
    ...
    static func configure(pageURL: URL) {
        pageChannel = SurfaceCH5URLConfig.channel(from: pageURL)
    }

//
//  SurfaceCH5PaymentManager.swift
//  App
//
...
extension Notification.Name {
    static let surfaceCH5PaymentTransactionUpdated = Notification.Name("surfaceCH5PaymentTransactionUpdated")
}

@MainActor
final class SurfaceCH5PaymentManager {
    static let shared = SurfaceCH5PaymentManager()

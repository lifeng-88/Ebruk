//
//  SurfaceCH5AppPaymentController.swift
//  App
//
...
final class SurfaceCH5AppPaymentController: UIViewController, WKNavigationDelegate {
    private let url: URL
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        if SurfaceCH5PaymentRedirectReturnURL.matches(navigationURL) {
            didNotifyClose = true
            SurfaceCH5PaymentCallbackManager.shared.handle(url: navigationURL)
            dismiss(animated: true)

//
//  VlStoreKitOrderFingerprintMap.swift
//  Velo
//
...
/// 订单号与 appAccountToken(UUID) 的映射，供 VlStoreKitPurchaseOrchestrator 购买与漏单处理使用
final class VlStoreKitOrderFingerprintMap {
    static let shared = VlStoreKitOrderFingerprintMap()

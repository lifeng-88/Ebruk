//
//  VlCatalogMaterialDiskCache.swift
//  Velo
//
...
@MainActor
class VlCatalogMaterialDiskCache {
    static let shared = VlCatalogMaterialDiskCache()
    ...
    private func getCachedData<T: Codable>(fileName: String, as type: T.Type) -> T? {
        ...
        do {
            ...
            print("⚠️ [VlCatalogMaterialDiskCache] Failed to decode cached data from \(fileName): \(error)")
            return nil
        }
    }
    ...
    private func setCachedData<T: Codable>(fileName: String, data: T) {
        ...
        do {
            ...
            print("⚠️ [VlCatalogMaterialDiskCache] Failed to cache data to \(fileName): \(error)")
        }
    }
    ...
    func clearAllCache() {
        ...
        print("🗑️ [VlCatalogMaterialDiskCache] Cleared all cache")
    }
}

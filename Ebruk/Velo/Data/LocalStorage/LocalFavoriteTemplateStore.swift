...
extension Notification.Name {
    ...
    static let localFavoriteTemplateStoreDidChange = Notification.Name("velo.LocalFavoriteTemplateStore.didChange")
}
...
enum LocalFavoriteTemplateStore {
    ...
    private static let prefix = "velo.favorite.templateKeys.v1."

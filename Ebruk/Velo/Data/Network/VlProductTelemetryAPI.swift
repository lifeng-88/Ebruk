//
//  VlProductTelemetryAPI.swift
//  Velo
//
//  行为事件批量上报。协议文档：协议文档/统计与埋点协议.md
//  若出现 404：请确认 BFF 的 statistics 服务已在 8110 启动，且 nginx 将 /v1/statistics 转发到该服务；
...
/// 统计与埋点 API
enum VlProductTelemetryAPI {
    private static let client = VlHTTPGatewayActor.shared

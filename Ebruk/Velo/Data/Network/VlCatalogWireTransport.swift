...
struct VlCatalogWireTransport {
    ...
    static func getVideoTemplates(pageNum: Int32?, pageSize: Int32?, catalogId: Int32?, titleId: Int32) async -> Result<VideoTemplateListResponse, AppError> {
        ...
        if let catalogId = catalogId {
            ...
            print("🌐 [VlCatalogWireTransport] getVideoTemplates with catalogId: \(catalogId)")
        } else {
            print("🌐 [VlCatalogWireTransport] getVideoTemplates without catalogId (All categories)")
        }

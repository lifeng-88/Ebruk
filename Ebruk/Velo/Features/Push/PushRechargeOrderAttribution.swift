...
//  Velo
//
//  与网关约定一致：`recharge_incentive_new_user` 建单归因；支付成功后清除；冷启动按 userId 从 UserDefaults 恢复。
//
...
final class PushRechargeOrderAttributionStore: ObservableObject {
    ...
    private static let userDefaultsKeyPrefix = "velo.rechargeIncentiveNewUser.v1."
